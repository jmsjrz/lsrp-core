-- Ce fichier contient une table nommée LSRPShared.Weapons qui répertorie les différentes armes du jeu avec leurs caractéristiques.
-- Chaque arme est représentée par une clé qui correspond à son nom et une valeur qui est une table contenant les informations suivantes :
--   - name : le nom de l'arme
--   - label : le label de l'arme
--   - weapontype : le type de l'arme (Melee, Pistol, Submachine Gun, etc.)
--   - ammotype : le type de munitions utilisé par l'arme
--   - damagereason : la raison de la blessure causée par l'arme
