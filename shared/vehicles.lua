--- Module contenant la liste des véhicules partagés.
-- Cette liste contient les informations sur les véhicules disponibles dans le jeu.
-- @module LSRPShared.Vehicles

LSRPShared = LSRPShared or {}
LSRPShared.Vehicles = LSRPShared.Vehicles or {}

local Vehicles = {
    --- Compacts (0)
    {
        model = 'asbo',        -- Code de spawn du véhicule
        name = 'Asbo',         -- Nom affiché du véhicule
        brand = 'Maxwell',     -- Marque du véhicule
        price = 4000,          -- Prix de vente du véhicule
        category = 'compacts', -- Catégorie du véhicule, utilisez les options de GetVehicleClass() https://docs.fivem.net/natives/?_0x29439776AAA00A62
        type = 'automobile',   -- Type de véhicule, référez-vous ici https://docs.fivem.net/natives/?_0x6AE51D4B & ici https://docs.fivem.net/natives/?_0xA273060E
        shop = 'pdm',          -- Peut être un seul magasin ou plusieurs magasins. Par exemple {'nomdumagasin1','nomdumagasin2','nomdumagasin3'}
    },
...
for i = 1, #Vehicles do
    LSRPShared.Vehicles[Vehicles[i].model] = {
