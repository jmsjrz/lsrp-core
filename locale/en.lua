local Translations = {
    error = {
        ...
        duplicate_license           = '[LSRPCORE] - Duplicate Rockstar License Found',
        no_valid_license            = '[LSRPCORE] - No Valid Rockstar License Found',
        not_whitelisted             = '[LSRPCORE] - You\'re not whitelisted for this server',
        ...
        connecting_database_error   = '[LSRPCORE] - A database error occurred while connecting to the server. (Is the SQL server on?)',
        connecting_database_timeout = '[LSRPCORE] - Connection to database timed out. (Is the SQL server on?)',
    },
    success = {
